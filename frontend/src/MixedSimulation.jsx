...
import { orderedPracticalTasks } from './practicalFollowup.js';
import './mixedSimulation.css';

const DURATION = 15 * 60 * 1000;
const formatTime = seconds => `${Math.floor(seconds / 60)}:${String(seconds % 60).padStart(2, '0')}`;

export default function MixedSimulation({ profile, updateProfile, onOpenLesson, onOpenTask }) {
  ...
  const practical = orderedPracticalTasks(report, profile?.completed);
