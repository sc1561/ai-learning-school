...
export default function PythonLab({ lesson, profileId, onDone }) {
  ...
  const [code, setCode] = useState(() => savedDraft()?.code ?? lesson.code ?? '');
